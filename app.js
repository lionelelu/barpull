...
function renderOnboardingStep() {
  ...
  if (step === 1) {
    ...
    html += '<input type="password" id="ob-pin" class="sync-input" placeholder="Dejar vacío = sin PIN" maxlength="4" inputmode="numeric" pattern="[0-9]*" style="text-align:center;font-size:18px;letter-spacing:6px;max-width:160px">';
    html += '</div>';
  }
